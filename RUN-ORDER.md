...
| 14 | supabase-daily-streak.sql | **Daily streak** — roz claim → USDT reward (Day 1–6: $0.01–0.12, Day 7+: $0.20, miss = reset). Dashboard panel + coin sound; wallet history me "Daily streak" entry | 3 |
